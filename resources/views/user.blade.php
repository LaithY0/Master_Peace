                                                        ...
                                                        <div class="row m-l-0 m-r-0">
                                                            <div class="col-sm-4 bg-c-lite-green user-profile">
                                                                <div class="card-block text-center text-white">
                                                                    <div class="m-b-25">
                                                                        <img src="../img/me.JPG" class="img-radius" width="110rem" alt="User-Profile-Image">
                                                                    </div>
                                                                    <h3 class="f-w-600" id="name"></h3>
                                                                    <p id="member">Member</p>
                                                                    <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                                                  <button id="editbtn">  <i class="fa-solid fa-user-pen" id="edit"></i> </button>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="card-block">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <h6 class="text-muted f-w-400">23/11/2023</h6>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <p class="m-b-10 f-w-600">End in</p>
                                                                            <h6 class="text-muted f-w-400">24/12/2023</h6>
                                                                        </div>
                                                                    </div>
